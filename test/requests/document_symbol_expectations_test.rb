...
class DocumentSymbolExpectationsTest < ExpectationsTestRunner
  ...
  def test_rake_document_symbol_addon
    ...
    test_addon(:reload_rake_addon, source: source, path: "/fake.rake") do |executor|
      response = executor.execute({
        method: "textDocument/documentSymbol",
    ...
    test_addon(:reload_rake_addon, source: source, path: "/fake.rb") do |executor|
      response = executor.execute({
        method: "textDocument/documentSymbol",
        params: { textDocument: { uri: "file:///fake.rb" } },
      })
  ...
  def reload_rake_addon
    RubyLsp::Addon.addon_classes << RubyLsp::Addons::Rake
  end
end
